...
//    }
    ...
    public static HttpClientConnector populateSenderConfigurationOptions(SenderConfiguration senderConfiguration, Struct
            clientEndpointConfig, HttpWsConnectorFactory httpConnectorFactory,Map<String, Object> properties,
            BMap<String, BValue> globalPool) {
        ProxyServerConfiguration proxyServerConfiguration;
        ...
        if (connectionThrottling != null) {
            ...
            HttpClientConnectionManager globalConnManager = (HttpClientConnectionManager)globalPool.
